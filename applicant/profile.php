           ...
           <div class="panel panel-default">            
            <div class="panel-body"> 
              <div  id="image-container">
                <?php 
                  $photo = $applicant->APPLICANTPHOTO ? web_root.'applicant/'.$applicant->APPLICANTPHOTO : 'photos/default.png';
                ?>
                <img title="profile image" data-target="#myModal" data-toggle="modal" style="border-radius: 50%" src="<?php echo $photo; ?>">
              </div>
             </div>
          <ul class="list-group">
            ...
            <li class="list-group-item text-right"><span class="pull-left"><strong>Freelancer:</strong></span> 
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked"> 
                <li class="<?php echo ($view=='appliedjobs' || $view=='') ? 'active': '';?>"><a href="<?php echo web_root.'applicant/index.php?view=appliedjobs'; ?>"><i class="fa fa-list"></i> Applied Jobs
                 ...
                 <li class="<?php echo ($view=='accounts') ? 'active': '';?>"><a href="<?php echo web_root.'applicant/index.php?view=accounts'; ?>"><i class="fa fa-user"></i> Manage Account </a></li>
                 ...
                 <span class="label label-danger pull-right"><?php echo isset($showMsg->COUNT) ? $showMsg->COUNT : 0;?></span></a></li>
                 <li class="<?php echo ($view=='notification') ? 'active': '';?>"><a href="<?php echo web_root.'applicant/index.php?view=notification'; ?>"><i class="fa fa-bell-o"></i> Notifications
                  <span class="label label-danger pull-right"><?php echo $notif; ?></span>
                 </a></li> 
