...
<head>
<meta charset="utf-8">
<title>Handyman / <?php echo $title;?></title>
  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
               <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>(+63) 916 - 251 - 7763</p>
                <?php if (isset($_SESSION['APPLICANTID'])) { 
                    ...
                    <a title="View Message(s)" href="'.web_root.'applicant/index.php?view=message"> <i class="fa fa-envelope-o"></i> <span class="label label-danger">'.$msg.'</span></a>&nbsp;
                    <a title="View Notification(s)" href="'.web_root.'applicant/index.php?view=notification"> <i class="fa fa-bell-o"></i> <span class="label label-danger">'.$notif.'</span></a> |  
                    <a title="View Profile" href="'.web_root.'applicant/"> <i class="fa fa-user"> </i> '. $appl->FNAME. ' '.$appl->LNAME .' </a> | <a href="'.web_root.'logout.php" onclick="return confirm(\'Are you sure you want to log out?\');" >  <i class="fa fa-sign-out"> </i> LOGOUT</a> </p>';

                    }else{ ?>
                      <p class="pull-right login"><a data-target="#myModal" data-toggle="modal" href=""> <i class="fa fa-lock"></i> LOGIN </a>
                <?php } ?>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="<?php echo web_root; ?>index.php"><img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo" style="height: 40px"/></a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown <?php if(isset($_GET['q'])) { if($_GET['q']=='category'){ echo 'active'; }else{ echo ''; }} ?>">
                          ...
                          <ul class="dropdown-menu">
                            <?php 
                            $sql = "SELECT * FROM `tblcategory` WHERE `SERVICE_TYPE`='Virtual Services' LIMIT 5";
                            $mydb->setQuery($sql);
                            $cur = $mydb->loadResultList();

                            $viewresult = '<li class="divider"></li>';
                            echo $viewresult;
                            $viewresult = '<li class="dropdown-header">VIRTUAL SERVICES</li>';
                            echo $viewresult;
                            ...
                            $sql = "SELECT * FROM `tblcategory` WHERE `SERVICE_TYPE`='Physical Services' LIMIT 5";
                            $mydb->setQuery($sql);
                            $cur = $mydb->loadResultList();

                            $viewresult = '<li class="divider"></li>';
                            echo $viewresult;
                            $viewresult = '<li class="dropdown-header">PHYSICAL SERVICES</li>';
                            echo $viewresult;
                            foreach ($cur as $result) {
                              $viewresult = '<li><a href="'.web_root.'index.php?q=category&search='.$result->CATEGORY.'">'.$result->CATEGORY.'</a></li>';
                              echo $viewresult;
                            ...
                            $viewresult = '<li class="divider"></li>';
                            echo $viewresult;
                            $viewresult = '<li class="dropdown-header">OTHER SERVICES<a href="'.web_root .'index.php?q=category&search=Other Services"></a></li>';
                            echo $viewresult;
                            $sql = "SELECT * FROM `tblcategory` WHERE `SERVICE_TYPE` NOT IN ('Virtual Services', 'Physical Services') LIMIT 5";
                            $mydb->setQuery($sql);
                            $cur = $mydb->loadResultList();
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <p>
            <ul class="link-list">
              <li><i class="icon-phone"></i> (+63) 916 - 251 - 7763</li>
              <li><i class="icon-envelope-alt"></i><a href = "mailto: handymanmanagement@mail.com?subject = Feedback&body = Message">handymanmanagement@mail.com</a></li>
            </ul>
          </p>
        </div>
      </div>
        ...
        <div class="widget">
          ...
          <ul class="link-list">
            <?php 
                  ...
                  foreach ($cur as $result) {
                   echo '<li><a href="'.web_root.'index.php?q=viewjob&search='.$result->JOBID.'">'.$result->client_user.' / '.ucfirst($result->OCCUPATIONTITLE).'</a></li>';
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; 2023 Handyman. All Rights Reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
