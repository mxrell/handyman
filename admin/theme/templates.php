...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-lg"><b>HANDYMAN</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
         ...
         <?php
          ...
          // Check if the user's photo location is empty
          if(empty($singleuser->PICLOCATION)) {
            $profileImage = web_root.'admin/user/photos/default.png';
          } else {
          $profileImage = web_root.'admin/user/'. $singleuser->PICLOCATION;
          }
        ?>
...
<li class="dropdown user user-menu" style="padding-right: 15px;">
  ...
  <ul class="dropdown-menu">
    ...
    <li class="user-header">
      <img data-target="#menuModal" data-toggle="modal" src="<?php echo $profileImage; ?>" class="img-circle" alt="User Image">
    </li>
    <!-- Menu Footer-->
    <li class="user-footer">
      ...
      <div class="pull-right">
        <a href="<?php echo web_root ;?>admin/logout.php" class="btn btn-default btn-flat" onclick="return confirm('Are you sure you want to sign out?')">Sign out</a>
      </div>
    </li>
  </ul>
</li>
  ...
  <div class="modal fade" id="menuModal" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?php echo web_root; ?>admin/user/controller.php?action=photos" enctype="form-data" method="post">
      ...
      <ul class="sidebar-menu"> 
        ...
        <li class="<?php echo (currentpage() == 'vacancy') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/vacancy/">
            <i class="fa fa-suitcase"></i> <span>Job Vacancy</span> 
          </a>
        </li>
        <li class="<?php echo (currentpage() == 'employee') ? "active" : false;?>" >
          <a href="<?php echo web_root ;?>admin/employee/">
            <i class="fa fa-users"></i> <span>Hired Freelancers</span> 
          </a>
        </li> 
        ...
        <li class="<?php echo (currentpage() == 'search') ? "active" : false;?>" > 
          <a href="<?php echo web_root ;?>admin/search/">
            <i class="fa fa-search"></i> <span>Find Freelancers</span> 
          </a>
        </li> 
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="#">Handyman</a>.</strong> All Rights
    Reserved.
  </footer>
    </body>
