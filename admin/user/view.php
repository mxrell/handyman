...
<div class="panel-body inf-content">
    <div class="row">
        <div class="col-md-4">
        <?php 
          $image_path = !empty($singleuser->PICLOCATION) ? web_root.'admin/user/'. $singleuser->PICLOCATION : 'photos/default.png';
        ?>
        <a data-target="#myModal" data-toggle="modal" href="" title="Click here to Change Image.">
            <img alt="" style="width:500px; height:350px;" title="" class="img-circle img-thumbnail isTooltip" src="<?php echo $image_path;?>"        data-original-title="Usuario"> 
        </a>
        </div>
        <div class="col-md-6">
             ...
             <form class="form-horizontal span6" action="controller.php?action=edit&view=" method="POST">
                <input id="USERID" name="USERID" type="Hidden" value="<?php echo $singleuser->USERID; ?>">
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "U_NAME">Contact no.:</label>
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_CONTACTNO" name="U_CONTACTNO" placeholder=
                            "Contact no." type="text" value="<?php echo $singleuser->CONTACTNO; ?>" required>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_EMAIL" name="U_EMAIL" placeholder=
                            "sample@mail.com" type="text" value="<?php echo $singleuser->EMAIL; ?>" required>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_USERNAME" name="U_USERNAME" placeholder=
                            "Account Username" type="text" value="<?php echo $singleuser->USERNAME; ?>" required>
                      </div>
                    </div>
                  </div>
