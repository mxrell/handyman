    ...
    <h1 class="login-box-msg">HANDYMAN</h1>
      ...
      <form action="" method="post">
        ...
        <div class="col-xs-4">
          ...
          <br><br><br>
          <a href="register.php">&nbsp&nbsp&nbsp&nbsp&nbspDon't have an account?</a><br>
...
if(isset($_POST['btnLogin'])){
  ...
  $h_upass = sha1($upass);
   ...
   if ($email == '' OR $upass == '') {
    ...
    if ($res==true) { 
       message("You are succesfully logged in!","success");
        ...
        unset($_SESSION['PICLOCATION']);
         ...
         redirect(web_root."admin/vacancy");
      // } 
    }else{
      message("Account does not exist! Please try again!", "error");
