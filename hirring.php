...
if (isset($_GET['search'])) {
    $client_user = $_GET['search'];
} else {
    $client_user = '';
}

$sql = "SELECT JOBID, OCCUPATIONTITLE, client_user, DATEPOSTED,job_address
        FROM `tbljob`
        WHERE client_user LIKE '%" . $client_user . "%'
...
foreach ($cur as $result) {
    ...
    echo '<td>'.$result->client_user.'</td>';
    echo '<td><a href="https://www.google.com/maps/search/'.$result->job_address.'" target="_blank">'.$result->job_address.'</a></td>';
